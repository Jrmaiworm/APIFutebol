...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './jogador.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_JOGADOR_LIST actions', async () => {
    ...
    it('dispatches FETCH_JOGADOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_JOGADOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_JOGADOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_JOGADOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_JOGADOR actions', async () => {
      const expectedActions = [
        {
