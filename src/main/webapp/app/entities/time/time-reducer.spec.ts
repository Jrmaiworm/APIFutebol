...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './time.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TIME_LIST actions', async () => {
    ...
    it('dispatches FETCH_TIME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TIME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TIME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TIME actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TIME actions', async () => {
      const expectedActions = [
        {
